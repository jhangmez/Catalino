<%-- 
    Document   : llama_reporte2
    Created on : 22/04/2022, 01:20:54 PM
    Author     : Airth
--%>
    ...
    <body>
        <header class="header">
            <div class="container">
                ...
                <form class="busca" align="center" action="Reporte2.jsp" method="post" target="ventana_iframe">

                    <input type="text" name="dato" id="dato">

                    <button type="submit" value="Generar PDF" class="btn btn-secondary">Generar PDF</button>
                </form>
                <br>
                <div align="center">
                    <iframe src="" marginwidth="0" marginheight="0" name="ventana_iframe" 
                            scrolling="no" frameborder="0" width="80%" height="600" class="col-12 mt-5">
                    </iframe>
                </div>
